...
class EditImages extends StatefulWidget {
  final sProductID, sProductList;

  const EditImages({super.key, this.sProductID, this.sProductList});
...
// Function to convert a list of Files to base64
  ...
  getsessionData() async {
    ...
    setState(
      () {
        _imageUrlList = widget.sProductList;
        print("Select Images :: ${_selectedImages}");
        print("_imageUrlList :: ${_imageUrlList}");
      },
    );
  }
  ...
  void addImage() async {
    ...
    Map<String, dynamic> body = {
      ...
      "images": _imageUrlList.toString(),
    };
    print("Base 64 List :: ${base64List.toString()}");
