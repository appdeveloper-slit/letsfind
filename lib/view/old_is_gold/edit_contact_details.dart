...
class EditOwnerContact extends StatefulWidget {
  final sContact, sType;

  const EditOwnerContact({Key? key, this.sContact, this.sType})
      : super(key: key);

  @override
  State<EditOwnerContact> createState() => _EditOwnerContactState();
}

class _EditOwnerContactState extends State<EditOwnerContact> {
  ...
  String? sCity, slat, slng, sEditCity;
  ...
  getsessionData() async {
    ...
    if (widget.sType == "edit") {
      setState(() {
        ...
        sEditCity = widget.sContact['city_id'].toString();
                            ...
                            child: Card(
                              ...
                              shape: OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color:
                                          Clr().borderColor.withOpacity(0.8)),
                                  borderRadius: BorderRadius.circular(18)),
                              color: Clr().white,
                              surfaceTintColor: Clr().white,
                              child: Padding(
