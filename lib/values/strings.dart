class Str {
  ...
  String invalidName = "*Enter valid Name";
  String invalidMobile = "*Enter valid Mobile Number";
  String invalidAmount = "Please enter amount";
  // String invalidEmail = "Please enter a valid email";
  String invalidEmail = "*Enter valid Email Address";
  ...
  String invalidCoupon = "Enter coupon code";
  ...
  String aboutUs =
      "Metro Bharat- National Level Hindi News, LIVE TV, Latest News and Breaking Metro Bharat is the new benchmark application in the world of News in which you can easily get news from local level to many others fields like, Politics, crime, social, business and also from Bollywood.. Metro Bharat have its own professional team of reporters who cover actual ground reporting and deliver news with more accuracy. At a same time a complete team of desk reporter, video editors and highly qualified anchors who provide you every news with proper explanation";
}
